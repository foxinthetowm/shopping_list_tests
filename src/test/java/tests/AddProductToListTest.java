...
public class AddProductToListTest extends AndroidSetup {
    ...
    public static Object[][] listNames( ) {
        return new Object[][]{ { "New list", "product1", "", "", "",
                "kg.", "Pet products", "0" }, { "New list1",
    ...
    @Test(description = "[TC2] Add product with different parameters " +
            "combinations",
            dataProvider =
                    "Products parameters")
    ...
    @AfterMethod public void restartApp( ) {
        driver.resetApp();
    }
